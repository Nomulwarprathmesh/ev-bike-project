    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Assigned Scooter Lineup</h1>
            <p className="text-gray-600 mt-1">
              View admin-controlled scooters assigned to your showroom. Pricing and catalog changes require admin approval.
            </p>
          </div>
        </div>
        ...
        <Card className="p-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
            ...
            <div className="flex-1 relative">
              ...
              <Input
                placeholder="Search assigned scooters..."
                value={searchTerm}
        ...
        <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as typeof activeTab)} className="w-full">
          <TabsList className="grid w-full grid-cols-3 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white/90 backdrop-blur-md border border-gray-100 rounded-3xl p-1">
            ...
            <TabsTrigger value="stock" className="gap-2 rounded-2xl data-[state=active]:bg-blue-100 data-[state=active]:text-gray-900">
              ...
              <span className="hidden sm:inline">Stock View</span>
          ...
          <TabsContent value={activeTab} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <p className="text-sm text-gray-600">
                Showing <span className="font-semibold">{filteredProducts.length}</span> of {getBaseProducts().length} scooter model(s)
              </p>
            </div>
                      ...
                      <table className="w-full">
                        <thead className="bg-gray-50">
                          <tr>
                            ...
                            <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Admin Price</th>
                            ...
                            <tr key={product.id} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap">
                                <Badge className={`${
                                  ...
                                  {activeTab === "accepted" ? "Assigned" : activeTab === "rejected" ? "Not Assigned" : "Stock View"}
                                </Badge>
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{product.range} km</td>
                              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <Button variant="outline" size="sm" className="mr-2">Request Price</Button>
