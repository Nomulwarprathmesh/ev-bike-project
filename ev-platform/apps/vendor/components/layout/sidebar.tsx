...
const menuItems = [
  ...
  { icon: Package, label: "Assigned Scooters", href: "/products" },
  { icon: Warehouse, label: "Showroom Inventory", href: "/inventory" },
  { icon: ClipboardList, label: "Stock Requests", href: "/stock-requests" },
  { icon: ShoppingCart, label: "Orders", href: "/orders" },
  { icon: Truck, label: "Deliveries", href: "/deliveries" },
  { icon: Wrench, label: "Services", href: "/services" },
  { icon: Bike, label: "Repairs", href: "/repairs" },
  { icon: Zap, label: "Spare Parts", href: "/spare-parts" },
  { icon: Tags, label: "Pricing Requests", href: "/pricing-requests" },
  { icon: Users, label: "Customers", href: "/customers" },
  { icon: MessageSquare, label: "Admin Chat", href: "/admin-chat" },
  { icon: Store, label: "Showroom Profile", href: "/showroom" },
        ...
        {!collapsed && (
          <div className="p-4 border-t border-gray-100">
            <div className="text-xs text-gray-600">
              ...
              <p>Dealer operations workspace</p>
            </div>
          </div>
        )}
      </aside>
