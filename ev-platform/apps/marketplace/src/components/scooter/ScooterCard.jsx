...
import { Heart, GitCompare, Zap, Gauge, Battery, Star, ArrowRight, MapPin } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-1.5 rounded-2xl bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-600">
          <MapPin size={12} className="text-primary" />
          {scooter.showroomAvailability ?? 'Available at approved city showrooms'}
        </div>
