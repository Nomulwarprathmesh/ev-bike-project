  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Inventory Distribution</h1>
          <p className="text-sm text-gray-400 mt-1">Approve dealer stock requests, transfer central inventory, and track city-wise showroom availability.</p>
        </div>
