...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-2xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-slate-900 text-white hover:bg-slate-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.06)] hover:-translate-y-0.5",
        outline:
          "border border-gray-200 bg-white hover:bg-gray-50 text-gray-900 hover:border-gray-300 shadow-[0_4px_12px_rgb(0,0,0,0.02)]",
        secondary:
          "bg-gray-100 text-gray-900 hover:bg-gray-200 aria-expanded:bg-gray-200 aria-expanded:text-gray-900",
        ghost:
          "hover:bg-gray-100 text-gray-900 aria-expanded:bg-gray-100 aria-expanded:text-gray-900",
        destructive:
          "bg-gray-200 text-gray-900 hover:bg-gray-300 focus-visible:border-gray-400 focus-visible:ring-gray-200",
